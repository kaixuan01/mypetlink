...
export const mockPets: Pet[] = [
  {
    ...
    photoInitial: "M",
    photoTone: "apricot",
    profilePhotoLabel: "Milo smiling portrait",
    coverPhotoLabel: "Evening walk cover photo",
    coverTone: "sky",
    qrStatus: "active",
  ...
  },
  {
    ...
    photoInitial: "L",
    photoTone: "mint",
    profilePhotoLabel: "Luna window portrait",
    coverPhotoLabel: "Sunny window cover photo",
    coverTone: "mint",
    qrStatus: "draft",
