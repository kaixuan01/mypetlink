...
namespace MyPetLink.Api.Migrations
{
    ...
    [Migration("20260925074959_AddCommunityModeration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyPetLink.Api.Entities.MomentCollaboration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("MomentId", "InviteeUserId")
                        .IsUnique()
                        .HasDatabaseName("IX_MomentCollaborations_Live")
                        .HasFilter("[Status] IN (N'Pending', N'Accepted')");

                    b.HasIndex("MomentId", "Status");

                    b.HasIndex("InviteeUserId", "Status", "ExpiresAt");

                    b.ToTable("MomentCollaborations", null, t =>
                        {
                            t.HasCheckConstraint("CK_MomentCollaborations_State", "([Status] = N'Pending' AND [RespondedAt] IS NULL AND [EndedAt] IS NULL) OR ([Status] = N'Accepted' AND [RespondedAt] IS NOT NULL AND [EndedAt] IS NULL) OR ([Status] = N'Declined' AND [RespondedAt] IS NOT NULL AND [EndedAt] IS NULL) OR ([Status] IN (N'Revoked', N'Left', N'Dissolved', N'Expired') AND [EndedAt] IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("MyPetLink.Api.Entities.MomentCollaborationPet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CollaborationId", "PetId")
                        .IsUnique();

                    b.ToTable("MomentCollaborationPets", (string)null);
                });
            ...
            modelBuilder.Entity("MyPetLink.Api.Entities.MomentCommentMention", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CommentId", "Start")
                        .IsUnique();

                    b.HasIndex("MentionedUserId", "CommentId");

                    b.ToTable("MomentCommentMentions", null, t =>
                        {
                            t.HasCheckConstraint("CK_MomentCommentMentions_Span", "[Start] >= 0 AND [Length] >= 4 AND [Length] <= 31 AND [Start] + [Length] <= 500");
                        });
                });
            ...
            modelBuilder.Entity("MyPetLink.Api.Entities.MomentCollaboration", b =>
                {
                    b.HasOne("MyPetLink.Api.Entities.User", "InviteeUser")
                        .WithMany()
                        .HasForeignKey("InviteeUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MyPetLink.Api.Entities.User", "InviterUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MyPetLink.Api.Entities.MomentCollaborationPet", b =>
                {
                    b.HasOne("MyPetLink.Api.Entities.MomentCollaboration", "Collaboration")
                        .WithMany("Pets")
            ...
            modelBuilder.Entity("MyPetLink.Api.Entities.MomentCommentMention", b =>
                {
                    ...
                    b.HasOne("MyPetLink.Api.Entities.User", "MentionedUser")
                        .WithMany()
