...
builder.Services.AddRateLimiter(options =>
{
    ...
    AddSocialPolicy(
        options,
        SocialRateLimitPolicies.Comment,
...
builder.Services.AddScoped<IPetSocialSettingsService, PetSocialSettingsService>();
builder.Services.AddScoped<SocialMomentProjection>();
