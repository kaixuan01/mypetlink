 ...
 * cover it.
 *
 * **A gallery, not a feed.** This is one household's body of work seen at a
 * glance, so it stays dense and its tiles stay compact. Home and Explore read
 * one Moment at a time and use the full card instead.
 *
