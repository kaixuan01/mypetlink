...
export function merchant(overrides: Partial<AdminMerchant> = {}): AdminMerchant {
  return {
    ...
    commissionPlan: "LegacyPercentage",
    acquiredBySalespersonId: null,
    acquiredBySalespersonName: null,
    acquisitionAttributedAt: null,
    firstQualifyingPaidOrderAt: null,
    firstQualifyingMerchantOrderId: null,
    firstQualifyingMerchantOrderNumber: null,
    repeatCommissionPercentage: null,
    repeatCommissionEligibilityMonths: null,
    repeatCommissionEligibleUntil: null,
    paymentTerm: "Prepaid",
...
export function commission(
  ...
  return {
    ...
    commissionType: "MerchantOrderPercentage",
    merchantOrderId: "order-1",
    merchantPaymentId: "payment-1",
    tagOrderId: null,
    sourceOrderNumber: "MPL-B2B-ORD-260806-0001",
    salespersonId: "rep-1",
    salespersonCode: "MPL-SALES-001",
    salespersonName: "Nur Aisyah",
    ...
    commissionRuleEffectiveFrom: null,
    status: "Payable",
