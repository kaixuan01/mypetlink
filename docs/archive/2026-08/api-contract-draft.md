...
> Historical draft. For current backend planning, use [`api-contract-v1-draft.md`](../../api/api-contract-v1-draft.md), which adds `/api/v1` versioning, Phase A auth, provider-neutral media/payment proof design, audit logging, scan analytics consent rules, and configurable plans.
