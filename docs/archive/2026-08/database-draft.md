...
> Historical draft. For current backend planning, use [`schema-v1-draft.md`](../../database/schema-v1-draft.md), which adds Phase A auth, configurable plans, reusable media files, provider-neutral payment proofs, production audit logs, scan analytics consent rules, and secure random public identifiers.
