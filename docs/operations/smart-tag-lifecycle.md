...
- `/q/:safetyCode` — **Safety Profile**. Free, pet-level, finder-first safety/contact page. Exists even without buying a physical tag. Owner UI: "Safety Profile".
...
- pet-level Safety Profile `/q/:safetyCode`
